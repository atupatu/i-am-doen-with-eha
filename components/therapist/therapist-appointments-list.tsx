...
interface AppointmentProps {
  ...
  start_time: string
  end_time: string
  status: "pending" | "approved" | "declined" | "completed" | "confirmed" | "cancelled"
  report_content?: string
  report_submitted_at?: string
}
        ...
        {appointments.map((appointment) => (
          <div key={appointment.sid} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-gray-50">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {appointment.status === "pending" && (
                <>
                  <Button
                    ...
                    onClick={() => updateAppointmentStatus(appointment.sid, "confirmed")}
                  ...
                  <Button
                    ...
                    onClick={() => updateAppointmentStatus(appointment.sid, "cancelled")}
                    disabled={loading[appointment.sid]}
                  >
              ...
              {/* Approved/Confirmed appointments - show reschedule and report buttons */}
              {(appointment.status === "approved" || appointment.status === "confirmed") && (
                <>
                  <Button
                    variant="outline"
