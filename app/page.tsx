    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        */}
        ...
        <section ref={scheduleRef} className="py-16 bg-[#c8e6c9]/20">
          <div className="container">
            ...
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-lg max-w-3xl mx-auto">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="border-t pt-6 md:border-t-0 md:border-l md:pl-6 md:pt-0">
                  ...
                  <p className="text-gray-600 mb-6">Our team is here to help. Reach out to us for any inquiries.</p>
                  <Button
                    variant="outline"
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-600 hover:text-[#a98cc8]">Home</Link></li>
                <li><Link href="/therapists" className="text-gray-600 hover:text-[#a98cc8]">Therapists</Link></li>
                <li><Link href="/info" className="text-gray-600 hover:text-[#a98cc8]">Info</Link></li>
                <li><Link href="/schedule" className="text-gray-600 hover:text-[#a98cc8]">Schedule</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Resources</h3>
              <ul className="space-y-2">
                <li><Link href="#" className="text-gray-600 hover:text-[#a98cc8]">Blog</Link></li>
                <li><Link href="#" className="text-gray-600 hover:text-[#a98cc8]">FAQ</Link></li>
                <li><Link href="#" className="text-gray-600 hover:text-[#a98cc8]">Privacy Policy</Link></li>
                <li><Link href="#" className="text-gray-600 hover:text-[#a98cc8]">Terms of Service</Link></li>
              </ul>
            </div>
            <div>
